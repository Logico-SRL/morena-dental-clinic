const IOCServiceTypes = {
    ...
    MacroProjectsService: Symbol.for("MacroProjectsService"),
...
const IOCControllerTypes = {
    ...
    MacroProjectsController: Symbol.for("MacroProjectsController"),
    MacroProjectController: Symbol.for("MacroProjectController"),
